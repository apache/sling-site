...
def bundles=[
  ...
  "JCR Oak Server|org.apache.sling.jcr.oak.server|1.2.6|Y|jar",
  ...
  "Scripting Core|org.apache.sling.scripting.core|2.3.2|Y|jar",
  ...
  "Scripting HTL Engine|org.apache.sling.scripting.sightly|1.4.2-1.4.0|Y|jar",
