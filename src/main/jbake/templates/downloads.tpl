...
def mavenPlugins=[
  ...
  "Sling Feature Maven Plugin|slingfeature-maven-plugin|1.7.0|Y",
...
def bundles=[
  ...
  "Engine|org.apache.sling.engine|2.15.0|Y|jar",
  ...
  "Servlets Resolver|org.apache.sling.servlets.resolver|2.9.12|Y|jar",
