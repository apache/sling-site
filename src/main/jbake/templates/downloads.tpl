...
def mavenPlugins=[
  ...
  "Sling Feature Maven Plugin|slingfeature-maven-plugin|1.8.0|Y",
...
def bundles=[
  ...
  "Engine|org.apache.sling.engine|2.15.8|Y|jar",
  ...
  "Resource Resolver|org.apache.sling.resourceresolver|1.11.2|Y|jar",
  ...
  "XSS Protection API|org.apache.sling.xss|2.4.0|Y|jar",
