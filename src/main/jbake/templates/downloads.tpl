...
def slingApplication=[
  ...
  "Sling Feature Model Launcher|A tool for launching OSGi applications|org.apache.sling.feature.launcher|.zip|1.2.4|Y",
...
def bundles=[
  ...
  "Engine|org.apache.sling.engine|2.13.0|Y|jar",
