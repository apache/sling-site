...
def bundles=[
  ...
  "JCR Oak Server|org.apache.sling.jcr.oak.server|1.4.0|Y|jar",
  ...
  "Servlets Resolver|org.apache.sling.servlets.resolver|2.10.0|Y|jar",
  ...
  "Testing Clients|org.apache.sling.testing.clients|3.0.20|Y|jar",
