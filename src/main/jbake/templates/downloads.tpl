...
def bundles=[
  ...
  "Distribution Core|org.apache.sling.distribution.core|0.7.2|Y|jar",
  ...
  "Resource Resolver|org.apache.sling.resourceresolver|1.12.4|Y|jar",
  ...
  "Scripting HTL JS Use Provider|org.apache.sling.scripting.sightly.js.provider|1.2.12|Y|jar",
