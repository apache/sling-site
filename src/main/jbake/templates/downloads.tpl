...
def mavenPlugins=[
  ...
  "Sling Feature Maven Plugin|slingfeature-maven-plugin|1.7.2|Y",
...
def bundles=[
  ...
  "Auth Core|org.apache.sling.auth.core|1.6.2|Y|jar",
  ...
  "Commons Johnzon|org.apache.sling.commons.johnzon|1.2.16|Y|jar",
