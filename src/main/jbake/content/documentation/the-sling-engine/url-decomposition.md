...
# Overview #
During the *Resource Resolution* step, the client request URI (as being returned by [HttpServletRequest.getRequestURI()](https://docs.oracle.com/javaee/6/api/javax/servlet/http/HttpServletRequest.html#getRequestURI())) is decomposed into the following parts (in exactly this order):
