...
such as the [PrivateAccessor](https://junit-addons.sourceforge.net/junitx/util/PrivateAccessor.html) from [junit-addons](https://junit-addons.sourceforge.net/) make that simpler.
