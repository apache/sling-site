...
see <a href="https://jackrabbit.apache.org/oak/docs/">The Jackrabbit Oak documentation</a>. The Jackrabbit integration has also been moved to the attic and is no longer maintained.
</div>
...
The hardest thing to do is probably getting the JDBC driver for your database. One option is to look at the bundles provided by Spring Source in their repository at <https://www.springsource.com/repository/>.

Another option is to create the bundle on your own using Peter Kriens' [bnd Tool](https://bnd.bndtools.org/):
...
This description is based on Tony Giaccone's description [Swapping Postgres for Derby](https://markmail.org/message/wlbfrukmjjsl33hh) sent to the Sling Users mailing list.
