...
when installing pipes bundle, [apache felix gogo](https://felix.apache.org/documentation/subprojects/apache-felix-gogo.html) commands are exposed to the console that allow you to
