...
| `requireImportProvider` | `requireImportProvider:=list of extensions` | `empty` | (since 2.5.4) This directive can be used to wait to load the files until an import provider for the specified extensions is available. See [SLING-11203](https://issues.apache.org/jira/browse/SLING-11203) |
