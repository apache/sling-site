title=Sling Health Check Tools (deprecated)
type=page
status=published
tags=healthchecks,operations
~~~~~~

**Sling Health Checks are deprecated - please migrate to [Felix Health Checks](https://felix.apache.org/documentation/subprojects/apache-felix-healthchecks.html) - see [migration guide](sling-health-check-tool.html) for instructions**

**_This documentation is kept temporarily for projects that have not yet migrated_**
