...
**Sling Health Checks are deprecated - please migrate to [Felix Health Checks](http://felix.apache.org/documentation/subprojects/apache-felix-healthchecks.html) - see [migration guide](sling-health-check-tool.html) for instructions**
