...
* Java 8 or higher
* [Maven](https://maven.apache.org) 3.3.9 or later; enforced by the Sling parent pom
...
[Sling IDE tooling](/documentation/development/ide-tooling.html) for some extra
...
For more information on this see the [Maven Surefire Docu](https://maven.apache.org/plugins/maven-surefire-plugin/examples/debugging.html).
