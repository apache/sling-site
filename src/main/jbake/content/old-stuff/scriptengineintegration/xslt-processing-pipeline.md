...
In the *Apache Sling Scripting W3C XML Processing Support* bundle, Juanjo Vàzquez has implemented XSLT processing support for Sling as another new scripting engine, based on the [Cocoon 3 pipeline engine](https://cocoon.apache.org/3.0/).
...
XSLT processing support is implemented in Sling as an scripting engine bundle named *Apache Sling Scripting W3C XML Processing Support*. This bundle is based on the [Cocoon 3 pipeline engine](https://cocoon.apache.org/3.0/) and uses the [W3C XProc language](https://www.w3.org/TR/xproc/) in order to specify pipelines to be processed.
...
The source code is found in the [contrib/scripting/xproc](https://svn.apache.org/repos/asf/incubator/sling/trunk/contrib/scripting/xproc) module.
...
As explained above, the bundle is able to perform a sequence of XSLT transforms on an XML document just as is expressed in a pipeline definition. A pipeline definition is a file with an xpl extension that follows the [W3C XProc grammar](https://www.w3.org/TR/xproc/). Only `p:xslt` steps are supported at the moment.
...
* [Cocoon 3 pipeline engine](https://cocoon.apache.org//3.0/)
* [W3C XProc language](https://www.w3.org/TR/xproc/)
* [SLING-893](https://issues.apache.org/jira/browse/SLING-893)
* [Mail list discussion](https://markmail.org/thread/33h5nhk5e3mswrue)
